...
int cluster_intersecting(const GEOSGeometry **geoms, uint32_t num_geoms, GEOSGeometry ***clusterGeoms, uint32_t *num_clusters);
int union_intersecting_pairs(const GEOSGeometry** geoms, uint32_t num_geoms, UNIONFIND* uf);
int union_related_pairs(const GEOSGeometry** geoms, uint32_t num_geoms, const char* im, UNIONFIND* uf);
